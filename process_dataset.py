...
class Preprocess:
    ...
    '''
    def __init__(self, meta_filename='D:/Auo/Deep_Hierarchical_Classification-main/Deep_1/dataset/pickle_files/meta', train_file='D:/Auo/Deep_Hierarchical_Classification-main/Deep_1/dataset/pickle_files/train', test_file='D:/Auo/Deep_Hierarchical_Classification-main/Deep_1/dataset/pickle_files/test',
                        image_write_dir='D:/Auo/Deep_Hierarchical_Classification-main/Deep_1/dataset/images/', csv_write_dir='D:/Auo/Deep_Hierarchical_Classification-main/Deep_1/dataset/', train_csv_filename='train.csv', test_csv_filename='test.csv'):
        '''Init params.
        '''
...
#        self.coarse_label_names, self.fine_label_names = read_meta(self.meta_filename)
        self.coarse_label_names = read_meta(self.meta_filename)
...
#                f.write(f'{self.image_write_dir}{filename}, {coarse_label}, {fine_label}\n')
                f.write(f'{self.image_write_dir}{filename}, {coarse_label}\n')
